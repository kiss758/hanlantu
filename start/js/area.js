var provinceList = [
    ...
    {name:'天津', cityList:[
        {name:'市辖区', areaList:['和平区','河东区','河西区','南开区','河北区','红桥区','塘沽区','汉沽区','大港区','东丽区','西青区','津南区','北辰区','武清区','宝坻区','滨海新区','蓟州区','宁河区','静海区','蓟州区']}
    ]},
    {name:'重庆', cityList:[
    ...
    {name:'广东', cityList:[
        {name:'广州市', areaList:['东山区','荔湾区','越秀区','海珠区','天河区','芳村区','白云区','黄埔区','番禺区','花都区','增城市','从化市','南沙区']},
        {name:'韶关市', areaList:['武江区','浈江区','曲江区','始兴县','仁化县','翁源县','乳源瑶族自治县','新丰县','乐昌市','南雄市']},
        {name:'深圳市', areaList:['罗湖区','福田区','南山区','宝安区','龙岗区','盐田区','坪山区','龙华区','光明区']},
        ...
        {name:'惠州市', areaList:['惠城区','惠阳区','博罗县','惠东县','龙门县','大亚湾区']},
        ...
        {name:'东莞市', areaList:['石龙镇','石排镇','茶山镇','企石镇','桥头镇','东坑镇','横沥镇','常平镇','虎门镇','长安镇','沙田镇','厚街镇','寮步镇','大岭山镇','大朗镇','黄江镇','樟木头镇','谢岗镇','塘厦镇','清溪镇','凤岗镇','麻涌镇','中堂镇','高埗镇','石碣镇','望牛墩镇','洪梅镇','道滘镇','南城街道','东莞生态园','莞城街道','虎门港管委会','松山湖管委会','万江街道','东城街道']},
    ...
    {name:'湖北', cityList:[
        {name:'武汉市', areaList:['江岸区','江汉区','乔口区','汉阳区','武昌区','青山区','洪山区','东西湖区','汉南区','蔡甸区','江夏区','黄陂区','新洲区','武汉经济技术开发区','东湖高新技术开发区']},
        ...
        {name:'襄阳市', areaList:['襄城区','樊城区','襄阳区','南漳县','谷城县','保康县','老河口市','枣阳市','宜城市','襄州区']},
    ...
    {name:'湖南', cityList:[
        ...
        {name:'永州市', areaList:['芝山区','冷水滩区','祁阳县','东安县','双牌县','道　县','江永县','宁远县','蓝山县','新田县','江华瑶族自治县','零陵区']},
    ...
    {name:'河北', cityList:[
        ...
        {name:'唐山市', areaList:['路南区','路北区','古冶区','开平区','丰南区','丰润区','滦　县','滦南县','乐亭县','迁西县','玉田县','唐海县','遵化市','迁安市','曹妃甸区']},
        ...
        {name:'保定市', areaList:['新市区','北市区','南市区','满城县','清苑县','涞水县','阜平县','徐水县','定兴县','唐　县','高阳县','容城县','涞源县','望都县','安新县','易　县','曲阳县','蠡　县','顺平县','博野县','雄　县','涿州市','定州市','安国市','高碑店市','莲池区','竞秀区']},
    ...
    {name:'河南', cityList:[
        ...
        {name:'开封市', areaList:['龙亭区','顺河回族区','鼓楼区','南关区','郊　区','杞　县','通许县','尉氏县','开封县','兰考县','禹王台区']},
        {name:'洛阳市', areaList:['老城区','西工区','廛河回族区','涧西区','吉利区','洛龙区','孟津县','新安县','栾川县','嵩　县','汝阳县','宜阳县','洛宁县','伊川县','偃师市']},
        {name:'平顶山市', areaList:['新华区','卫东区','湛河区','石龙区','舞钢市','叶县','鲁山','宝丰','郏县','汝州市']},
        ...
        {name:'省辖市', areaList:['济源市']}
        
    ]},
    {name:'山西', cityList:[
        {name:'太原市', areaList:['小店区','迎泽区','杏花岭区','尖草坪区','万柏林区','晋源区','清徐县','阳曲县','娄烦县','古交市']},
        {name:'大同市', areaList:['城　区','矿　区','南郊区','新荣区','阳高县','天镇县','广灵县','灵丘县','浑源县','左云县','大同县','平城区','云冈区']},
    ...
    {name:'浙江', cityList:[
        ...
        {name:'嘉兴市', areaList:['秀城区','秀洲区','嘉善县','海盐县','海宁市','平湖市','桐乡市','南湖区']},
        {name:'湖州市', areaList:['吴兴区','南浔区','德清县','长兴县','安吉县']},
        {name:'绍兴市', areaList:['越城区','绍兴县','新昌县','诸暨市','上虞市','嵊州市','柯桥区']},
    ...
    {name:'安徽', cityList:[
        {name:'合肥市', areaList:['瑶海区','庐阳区','蜀山区','包河区','长丰县','肥东县','肥西县','庐江县','滨湖新区','北城新区','巢湖市']},
        {name:'芜湖市', areaList:['镜湖区','马塘区','新芜区','鸠江区','芜湖县','繁昌县','南陵县','无为县','三山区','弋江区']},
        {name:'蚌埠市', areaList:['龙子湖区','蚌山区','禹会区','淮上区','怀远县','五河县','固镇县']},
        {name:'淮南市', areaList:['大通区','田家庵区','谢家集区','八公山区','潘集区','凤台县','寿　县']},
        {name:'马鞍山市', areaList:['金家庄区','花山区','雨山区','当涂县','博望区','和县','含山县']},
        {name:'淮北市', areaList:['杜集区','相山区','烈山区','濉溪县']},
        {name:'铜陵市', areaList:['义安区','铜官山区','狮子山区','郊　区','铜陵县','枞阳县']},
        {name:'安庆市', areaList:['迎江区','大观区','郊　区','怀宁县','枞阳县','潜山县','太湖县','宿松县','望江县','岳西县','桐城市','宜秀区']},
    ...
    {name:'山东', cityList:[
        {name:'济南市', areaList:['历下区','市中区','槐荫区','天桥区','历城区','长清区','平阴县','济阳县','商河县','章丘市','高新区','莱芜区']},
    ...
    {name:'辽宁', cityList:[
        {name:'沈阳市', areaList:['和平区','沈河区','大东区','皇姑区','铁西区','苏家屯区','东陵区','新城子区','于洪区','辽中县','康平县','法库县','新民市','浑南区','沈北新区']},
    ...
    {name:'吉林', cityList:[
        ...
        {name:'白山市', areaList:['八道江区','抚松县','靖宇县','长白朝鲜族自治县','江源县','临江市','浑江区']},
    ...
    {name:'黑龙江', cityList:[
        ...
        {name:'伊春市', areaList:['伊春区','南岔区','友好区','西林区','翠峦区','新青区','美溪区','金山屯区','五营区','乌马河区','汤旺河区','带岭区','乌伊岭区','红星区','上甘岭区','嘉荫县','铁力市','金林区']},
        ...
        {name:'大兴安岭地区', areaList:['呼玛县','塔河县','漠河县','加格达奇区']}
    ]},
    {name:'四川', cityList:[
        {name:'成都市', areaList:['锦江区','青羊区','金牛区','武侯区','成华区','龙泉驿区','青白江区','新都区','温江县','金堂县','双流县','郫　县','大邑县','蒲江县','新津县','都江堰市','彭州市','邛崃市','崇州市','温江区','简阳市','郫都区','高新区']},
        ...
        {name:'绵阳市', areaList:['涪城区','游仙区','三台县','盐亭县','安　县','梓潼县','北川羌族自治县','平武县','江油市','高新区']},
        {name:'广元市', areaList:['市中区','元坝区','朝天区','旺苍县','青川县','剑阁县','苍溪县','利州区']},
        ...
        {name:'宜宾市', areaList:['翠屏区','宜宾县','南溪县','江安县','长宁县','高　县','珙　县','筠连县','兴文县','屏山县','叙州区']},
        ...
        {name:'巴中市', areaList:['巴州区','通江县','南江县','平昌县','恩阳区']},
    ...
    {name:'贵州', cityList:[
        {name:'贵阳市', areaList:['市辖区','南明区','云岩区','花溪区','乌当区','白云区','小河区','开阳县','息烽县','修文县','清镇市','观山湖区']},
        {name:'六盘水市', areaList:['钟山区','盘州市','六枝特区','水城县','盘　县']},
        {name:'遵义市', areaList:['红花岗区','汇川区','遵义县','桐梓县','绥阳县','正安县','道真仡佬族苗族自治县','务川仡佬族苗族自治县','凤冈县','湄潭县','余庆县','习水县','赤水市','仁怀市','播州区']},
        ...
        {name:'黔西南布依族苗族自治州', areaList:['兴义市','兴仁县','普安县','晴隆县','贞丰县','望谟县','册亨县','安龙县','惠水县']},
    ...
    {name:'西藏', cityList:[
        ...
        {name:'昌都地区', areaList:['昌都县','江达县','贡觉县','类乌齐县','丁青县','察雅县','八宿县','左贡县','芒康县','洛隆县','边坝县','卡若区']},
        ...
        {name:'那曲地区', areaList:['那曲县','嘉黎县','比如县','聂荣县','安多县','申扎县','索　县','班戈县','巴青县','尼玛县','色尼区']},
    ...
    {name:'甘肃', cityList:[
        ...
        {name:'天水市', areaList:['秦城区','北道区','清水县','秦安县','甘谷县','武山县','张家川回族自治县','麦积区']},
    ...
    {name:'新疆', cityList:[
        ...
        {name:'伊犁哈萨克自治州', areaList:['伊宁市','奎屯市','伊宁县','察布查尔锡伯自治县','霍城县','巩留县','新源县','昭苏县','特克斯县','尼勒克县','霍尔果斯市']},
    ...
    {name:'内蒙古', cityList:[
        ...
        {name:'鄂尔多斯市', areaList:['东胜区','达拉特旗','准格尔旗','鄂托克前旗','鄂托克旗','杭锦旗','乌审旗','伊金霍洛旗','康巴什区']},
    ...
    {name:'广西', cityList:[
        ...
        {name:'梧州市', areaList:['万秀区','蝶山区','长洲区','苍梧县','藤　县','蒙山县','岑溪市','龙圩区']},
        ...
        {name:'玉林市', areaList:['玉州区','容　县','陆川县','博白县','兴业县','北流市','福绵区']},
    ...
    {name:'海南', cityList:[
        ...
        {name:'琼海市', areaList:['五指山市','大路镇','琼海市']},
